# `@acko-components/css-text-input`
...
<a href="https://decathlon.github.io/vitamin-web/@acko-components/showcase-css/?path=/docs/components-text-input--overview">
<img src="https://img.shields.io/badge/storybook-css-d891bc?style=flat&logo=storybook" alt="storybook" />
</a>
<a href="https://www.npmjs.com/package/@acko-components/css-text-input">
<img src="https://img.shields.io/npm/v/@acko-components/css-text-input?style=flat&logo=npm" alt="npm version" />
</a>
...
After installing [npm](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) or [yarn](https://yarnpkg.com/en/docs/install), you can install `@acko-components/css-text-input` with this command:

```sh
# with npm
npm i -S @acko-components/css-text-input

# with yarn
yarn add @acko-components/css-text-input
```
...
<link
  rel="stylesheet"
  href="https://unpkg.com/@acko-components/css-text-input"
/>
```
...
If you need to display icons in text input, you will need to install `@acko-components/icons` package.
...
Then follow instructions in [README of @acko-components/icons](https://www.npmjs.com/package/@acko-components/icons) :
...
```javascript
import '@acko-components/css-text-input/dist/index.css';
```
...
<link
  rel="stylesheet"
  href="./node_modules/@acko-components/css-text-input/dist/index.css"
/>
```

## Development

To know all the use cases and their associated code, [check out the showcase here](https://decathlon.github.io/vitamin-web/@acko-components/showcase-css/index.html?path=/docs/components-text-input--overview).
