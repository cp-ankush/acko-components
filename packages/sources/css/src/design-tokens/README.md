# `@acko-components/css-design-tokens`

> Decathlon Design System - Vitamin specific CSS styles for design tokens

<a href="https://decathlon.github.io/vitamin-web/@acko-components/showcase-css/index.html?path=/story/guidelines-colors--page"><img src="https://img.shields.io/badge/storybook-css-d891bc?style=flat&logo=storybook" alt="storybook" /></a>
<a href="https://www.npmjs.com/package/@acko-components/css-design-tokens"><img src="https://img.shields.io/npm/v/@acko-components/css-design-tokens?style=flat&logo=npm" alt="npm version" /></a>
...
After installing [npm](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) or [yarn](https://yarnpkg.com/en/docs/install), you can install `@acko-components/css-design-tokens` with this command:

```sh
# with npm
npm i -S @acko-components/css-design-tokens

# with yarn
yarn add @acko-components/css-design-tokens
```
...
<link
  rel="stylesheet"
  href="https://unpkg.com/@acko-components/css-design-tokens"
/>
```
...
<link
  rel="stylesheet"
  href="./node_modules/@acko-components/css-design-tokens/dist/index.css"
/>
```

## Development

To know all the use cases and their associated code, [check out the showcase guidelines here](https://decathlon.github.io/vitamin-web/@acko-components/showcase-css/index.html?path=/story/guidelines-colors--page).
